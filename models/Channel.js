...
const channelSchema = new mongoose.Schema(
    {
        ...
        profilePic: {
            url: {
                 type: String,
                 default: 'https://res.cloudinary.com/dvtc6coe2/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_gray,b_rgb:262c35/v1747590439/channel_pro_placeholder_wduo6q.png'
            },
